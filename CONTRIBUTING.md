...
### Issue #1: OpenAI Strict Schema overrides parameter default arguments with `None`

* **Affected Files**: [agentapi/agent/tools.py](file:///e:/Ansh-Stuffings/Work/Github/agentapi/agentapi/agent/tools.py), [agentapi/agent/agent.py](file:///e:/Ansh-Stuffings/Work/Github/agentapi/agentapi/agent/agent.py)
* **Severity**: High
* **Description**: 
...
* **Suggested Patch**:
  Update [agentapi/agent/agent.py](file:///e:/Ansh-Stuffings/Work/Github/agentapi/agentapi/agent/agent.py) inside `_execute_tool_calls`:
  ```python
              try:
...
* **Affected Files**: [agentapi/agent/tools.py](file:///e:/Ansh-Stuffings/Work/Github/agentapi/agentapi/agent/tools.py)
* **Severity**: Medium
...
* **Suggested Patch**:
  Update `parse_tool_args` in [agentapi/agent/tools.py](file:///e:/Ansh-Stuffings/Work/Github/agentapi/agentapi/agent/tools.py):
  ```python
...
* **Affected Files**: [agentapi/providers/openai_compatible.py](file:///e:/Ansh-Stuffings/Work/Github/agentapi/agentapi/providers/openai_compatible.py), [agentapi/providers/gemini.py](file:///e:/Ansh-Stuffings/Work/Github/agentapi/agentapi/providers/gemini.py)
* **Severity**: Medium
...
* **Suggested Patch**:
  Update `_safe_error_detail` in [agentapi/providers/openai_compatible.py](file:///e:/Ansh-Stuffings/Work/Github/agentapi/agentapi/providers/openai_compatible.py):
  ```python
...
* **Affected Files**: [agentapi/agent/agent.py](file:///e:/Ansh-Stuffings/Work/Github/agentapi/agentapi/agent/agent.py)
* **Severity**: Medium
...
* **Suggested Patch**:
  Update `_execute_tool_calls` in [agentapi/agent/agent.py](file:///e:/Ansh-Stuffings/Work/Github/agentapi/agentapi/agent/agent.py):
  ```python
...
* **Suggested Patch**:
  Update `__init__` in [agentapi/agent/agent.py](file:///e:/Ansh-Stuffings/Work/Github/agentapi/agentapi/agent/agent.py):
  ```python
...
* **Affected Files**: [tests/test_inmemory_conversations.py](file:///e:/Ansh-Stuffings/Work/Github/agentapi/tests/test_inmemory_conversations.py)
...
* **Suggested Patch**:
  Update `run` in [agentapi/agent/agent.py](file:///e:/Ansh-Stuffings/Work/Github/agentapi/agentapi/agent/agent.py):
  ```python
              except Exception as exc:
...
* **Affected Files**: [agentapi/providers/anthropic.py](file:///e:/Ansh-Stuffings/Work/Github/agentapi/agentapi/providers/anthropic.py)
...
* **Suggested Patch**:
  Update `_format_messages` in [agentapi/providers/anthropic.py](file:///e:/Ansh-Stuffings/Work/Github/agentapi/agentapi/providers/anthropic.py):
  ```python
...
* **Affected Files**: [agentapi/providers/gemini.py](file:///e:/Ansh-Stuffings/Work/Github/agentapi/agentapi/providers/gemini.py)
* **Severity**: High
* **Description**: 
...
* **Suggested Patch**:
  Update `_to_function_declarations` in [agentapi/providers/gemini.py](file:///e:/Ansh-Stuffings/Work/Github/agentapi/agentapi/providers/gemini.py):
  ```python
...
* **Affected Files**: [agentapi/providers/openai_compatible.py](file:///e:/Ansh-Stuffings/Work/Github/agentapi/agentapi/providers/openai_compatible.py)
* **Severity**: Medium
...
* **Suggested Patch**:
  Update `stream` in [agentapi/providers/openai_compatible.py](file:///e:/Ansh-Stuffings/Work/Github/agentapi/agentapi/providers/openai_compatible.py):
  ```python
                          try:
...
* **Affected Files**: [agentapi/agent/memory.py](file:///e:/Ansh-Stuffings/Work/Github/agentapi/agentapi/agent/memory.py)
...
* **Suggested Patch**:
  Update `InMemoryMemory` in [agentapi/agent/memory.py](file:///e:/Ansh-Stuffings/Work/Github/agentapi/agentapi/agent/memory.py):
  ```python
...
* **Affected Files**: [README.md](file:///e:/Ansh-Stuffings/Work/Github/agentapi/README.md)
* **Severity**: Low
...
* **Suggested Patch**:
  Update `_stream_generator` in [agentapi/agent/agent.py](file:///e:/Ansh-Stuffings/Work/Github/agentapi/agentapi/agent/agent.py):
  ```python
